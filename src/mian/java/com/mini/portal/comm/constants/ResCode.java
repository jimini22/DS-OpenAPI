...
public enum ResCode {
	...
	CD9012(9012, "데이터 암호화 처리에 실패했습니다."),
	CD9013(9013, "데이터 복호화 처리에 실패했습니다."),
	CD9020(9020, "게시글 비밀번호가 일치하지 않습니다."),
	CD9031(9031, "파일 읽기 처리에 실패했습니다."),
	CD9032(9032, "파일 쓰기 처리에 실패했습니다."),
	CD9033(9033, "파일 삭제 처리에 실패했습니다."),
	CD9040(9040, "SMS 인증에 실패했습니다."),
	CD9041(9041, "SMS 수신 받을 기관 인원이 없습니다."),
	CD9050(9050, "허용된 파일 확장자명이 아닙니다."),
	CD9060(9060, "Database 연동 작업 중 오류가 발생하였습니다."),
